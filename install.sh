...
curl --silent \
  ...
  https://api.github.com/repos/VinzxyO/ControlPanel-Installer/releases/latest |
  grep '"tag_name":' |
  sed -E 's/.*"([^"]+)".*/\1/'
}
...
WIKI_LINK="https://github.com/VinzxyO/ControlPanel-Installer/wiki"
GITHUB_URL="https://raw.githubusercontent.com/VinzxyO/ControlPanel-Installer/$SCRIPT_RELEASE"
